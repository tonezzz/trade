...
Welcome to the Dollar Price Database documentation portal. This is your central hub for all project documentation.

## 🚀 Quick Navigation

### I'm New Here
- [Start with the Main README](../README.md) - Project overview and quick start
- [Getting Started Guide](getting-started/quickstart.md) - Setup and installation
- [System Architecture](core/ARCHITECTURE.md) - Understand how the system works

### I Want to Use the System
- [API Guide](core/API_GUIDE.md) - Complete API reference
- [Trading Signals](features/signals/SIGNALS.md) - Trading signals system
- [Backtesting](features/backtesting/BACKTESTING.md) - Backtesting guide
- [User Interfaces](features/ui/TRADECANVAS_QUICKSTART.md) - TradeCanvas UI quick start

### I Need to Deploy/Configure
- [Deployment Guide](core/DEPLOYMENT.md) - Deployment and configuration
- [Configuration Management](../CONFIGURATION_MANAGEMENT.md) - SSOT and config guide
- [Troubleshooting](core/TROUBLESHOOTING.md) - Common issues and solutions

### I'm Developing/Extending
- [Knowledge Base](knowledge/README.md) - Patterns, lessons, best practices
- [Project Plan](reference/PROJECT_PLAN.md) - Project vision and phases
...
- [Backtesting Summary](features/backtesting/BACKTESTING_SUMMARY.md) - Implementation summary
...
- [Automation Guide](features/automation/AUTOMATION_GUIDE.md) - Complete automation guide
...
### Workflows
- [Workflows Overview](workflows/README.md) - Development workflows and processes

### Getting Started
- [Quick Start Guide](getting-started/quickstart.md) - Get the trade system up and running
...
- [Archive Index](../docs-archive/) - Historical documentation and strategy documents
...
1. **Check standard documentation first** (docs/) - How-to guides, references
2. **Search knowledge base** (docs/knowledge/) - Patterns, lessons, best practices
3. **Check archived docs** (docs-archive/) - Historical context
4. **Consult code** - Implementation details

---

## 🛠️ Skills and Tools

The project includes Devin CLI skills for automation:
...
- Consult decision log for technical rationale
...
- Update this portal when adding new docs
