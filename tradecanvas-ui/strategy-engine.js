...
class StrategyPanel {
    ...
    init() {
        this.buildControls();
        this.resultContainer.innerHTML = '<p style="color:#8b949e; font-size:13px; margin-top:6px;">Click "Run Backtest" to see results.</p>';
    }
    ...
    runBacktest() {
        if (!this.data || this.data.length === 0) {
            this.resultContainer.innerHTML = '<p style="color:#da3633;">No chart data loaded yet.</p>';
            return;
        }
...
function initStrategyPanel(chartLoader) {
